...
<meta name="twitter:image" content="https://jeremiahonealrbbcsc.netlify.app/assets/jeremiah-oneal-portrait.jpeg">`;
  ...
  const counter = `<div id="site-visit-counter" style="margin-top:14px;padding-top:12px;border-top:1px solid #393939;font-size:.86rem;color:#bbb">Website Visits: <strong id="site-visit-count" style="color:#efc653">—</strong></div><script>(function(){var k='jo_visit_counted';var shouldCount=!sessionStorage.getItem(k);fetch('/.netlify/functions/site-visits?count='+(shouldCount?'1':'0'),{cache:'no-store'}).then(function(r){return r.json()}).then(function(d){if(typeof d.count==='number'){document.getElementById('site-visit-count').textContent=d.count.toLocaleString();if(shouldCount)sessionStorage.setItem(k,'1')}}).catch(function(){var e=document.getElementById('site-visit-counter');if(e)e.style.display='none'})})();</script>`;
  if (!html.includes('id="site-visit-counter"')) html = html.replace('</footer>', counter + '</footer>');
